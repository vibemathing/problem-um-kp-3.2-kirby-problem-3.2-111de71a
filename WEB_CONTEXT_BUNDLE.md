...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.2-kirby-problem-3.2-111de71a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.2"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.2-kirby-problem-3.2-111de71a-v1",
      "problem_contract_sha256": "b33b9e22ae8414f800b6412eda2fc1140ce6176a085b02b60c4d7ebf9b8b6a6c",
      "problem_id": "problem:um-kp-3.2-kirby-problem-3.2-111de71a",
      "route_id": "route:um-kp-3.2-kirby-problem-3.2-111de71a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.2-kirby-problem-3.2-111de71a-source-fidelity-01",
      "graph_id": "graph:um-kp-3.2-kirby-problem-3.2-111de71a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.2-kirby-problem-3.2-111de71a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.2-kirby-problem-3.2-111de71a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Show that the volumes of hyperbolic 3-manifolds are not all rationally related."
          },
          "statement_sha256": "261fee5ef054714cecbfe1e6c2c41069c5e8d92f36ebbd215bef59f6c40898f4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.2-kirby-problem-3.2-111de71a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.2-kirby-problem-3.2-111de71a-root",
      "route_id": "route:um-kp-3.2-kirby-problem-3.2-111de71a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.2-cc45f316e1f0",
        "url": "https://www.unsolvedmath.com/problems/KP-3.2"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
